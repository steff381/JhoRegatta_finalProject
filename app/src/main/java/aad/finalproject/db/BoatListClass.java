...
public class BoatListClass {
    private static String LOGTAG = "Logtag: " + BoatListClass.class.getSimpleName() ;
    ...
    public static void setSelectedBoats() {
        ...
        for (int i = 0; i < boatList.size(); i++) {
            Log.i(LOGTAG, " Boat list entry is now " + boatList.get(i).getBoatName() + " and it isSelected = " + boatList.get(i).isSelected());
